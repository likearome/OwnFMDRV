...
CFLAGS=-0 -s -d0 -ms -wx -ot -DINTSIG_OFF=23 -DOWNFMDRV_VER="2.0.0" -DMAX_CDAUDIOTRACK=$(MAX_CDAUDIOTRACK)
...
$(OWNFMDRV_EXE): $(OWNFMDRV_OBJ)
	...
	wdis -l INTERUP
	wdis -l DOSUTIL
	copy $(OWNFMDRV_EXE) D:\Emulator\OwnFMDRV_WATCOM_Local\TESTBED\LEM
